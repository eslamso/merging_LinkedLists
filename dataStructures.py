...
class LinkedList:
    ...
    def addwithsort(self,item):
        ...
        if pervious==None:
            ...
            pervious.set_next(temp)
    def getLinkedlist(self):  # this method used to return linked list in from of a normal list for example : [5,3,2]
        current = self.head
        Linkedlist = []
        while current != None:
